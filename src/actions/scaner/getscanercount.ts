...
interface GetScanerCountPayload {
  userid: number;
}
...
const GetScanerCount = async (
  payload: GetScanerCountPayload
): Promise<ApiResponseType<ResponseType | null>> => {
  const functionname: string = GetScanerCount.name;
