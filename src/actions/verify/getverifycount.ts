...
interface GetVerifyCountPayload {
  userid: number;
}
...
const GetVerifyCount = async (
  payload: GetVerifyCountPayload
): Promise<ApiResponseType<ResponseType | null>> => {
  const functionname: string = GetVerifyCount.name;
