...
// new icons start from here
export function FluentPerson20Filled(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function FluentKey16Filled(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
    ...
    >
      <path
        fill="currentColor"
        d="M7.5 11.5v.5a.5.5 0 0 1-.5.5H6v.5a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1v-1.293A1 1 0 0 1 2.293 11l3.87-3.87A4 4 0 1 1 10 10H8.999v1a.5.5 0 0 1-.5.5zM11 6a1 1 0 1 0 0-2a1 1 0 0 0 0 2"
      ></path>
    </svg>
  );
}
...
export function FluentPersonLock16Regular(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        fill="currentColor"
        d="M7 14v-1c-2.568 0-4-1.562-4-3v-.5a.5.5 0 0 1 .5-.5h3.724A1.87 1.87 0 0 1 8.5 8.038V8h-5A1.5 1.5 0 0 0 2 9.5v.5c0 1.971 1.86 4 5 4m2.75-9.75a2.75 2.75 0 1 0-5.5 0a2.75 2.75 0 0 0 5.5 0m-4.5 0a1.75 1.75 0 1 1 3.5 0a1.75 1.75 0 0 1-3.5 0M9.5 8v1h-.625A.89.89 0 0 0 8 9.9v4.2c0 .497.392.9.875.9h5.25a.89.89 0 0 0 .875-.9V9.9c0-.497-.392-.9-.875-.9H13.5V8a2 2 0 1 0-4 0m2-1a1 1 0 0 1 1 1v1h-2V8a1 1 0 0 1 1-1m0 5.75a.75.75 0 1 1 0-1.5a.75.75 0 0 1 0 1.5"
      ></path>
    </svg>
  );
}
